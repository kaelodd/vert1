                ...
                <Card size="small">
                    {/* <div style={{}}>
                        <Space direction="horizontal">
                            <Button onClick={() => { download() }} style={{ marginLeft: 5, marginBottom: 20 }} type="primary" icon={<DownSquareOutlined />}>
                                Download
                            </Button>
                            <Button onClick={() => { sendToPoc() }} style={{ marginLeft: 5, marginBottom: 20 }} color="green">
